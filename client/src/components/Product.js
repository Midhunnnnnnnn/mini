  ...
  return (
    <div className="max-w-screen-xl mx-auto my-10 p-4">
      <div className="flex flex-col md:flex-row gap-10">
        ...
        <div className="w-full md:w-3/5 flex flex-col justify-center gap-6 md:gap-12">
          <div>
            <h2 className="text-2xl md:text-4xl font-semibold">{details.title}</h2>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="w-full md:w-52 flex items-center justify-between text-gray-500 gap-4 border p-3">
              ...
              <div className="flex items-center gap-4 text-sm font-semibold">
                <button
                  onClick={() =>
                    setBaseQty(baseQty === 1 ? 1 : baseQty - 1)
                  }
            ...
            <button
              ...
              className="bg-black text-white py-3 px-6 active:bg-gray-800 w-full md:w-auto"
            >
              Add to Cart
            </button>
          </div>
